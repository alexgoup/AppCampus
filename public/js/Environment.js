		...
		for(var i=0; i<this.currentBlist.length; i++){ 
			if(this.currentBlist[i].zone != undefined){ 
				...
				if( this.currentBlist[i].id == 166){ // Solar panels for Clough commons. hardcoded for now but needs function .addsolar
					...
					cloughSolar.position.y = (1/2)*cloughSolar.scaling.y + this.currentBlist[i].mesh3DList[8].scaling.y; 
				...
				if( this.currentBlist[i].id == 160){ // Solar panels for CRC. hardcoded for now but needs function .addsolar
					...
					crcSolar.scaling.x = this.currentBlist[i].mesh3DList[6].scaling.x*edgefactor; 
					crcSolar.scaling.z = this.currentBlist[i].mesh3DList[6].scaling.z*edgefactor; 
					...
					crcSolar.position.y = (1/2)*crcSolar.scaling.y + this.currentBlist[i].mesh3DList[6].scaling.y; 
					crcSolar.position.z = this.currentBlist[i].savez+0; 
					crcSolar.rotation.y = this.currentBlist[i].mesh3DList[6].rotation.y;
